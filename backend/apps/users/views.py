...
from .models import Customer, PetSitter
...
class LoginView(generics.GenericAPIView):
    ...
    @extend_schema(
        ...
        responses={
            200: OpenApiResponse(
                response=UserSerializer, description="Login successful"
            ),
...
class CustomerSignupView(generics.CreateAPIView):
    ...
    @extend_schema(
        ...
        responses={
            201: OpenApiResponse(
                response=CustomerSerializer, description="Customer successfully created"
            ),
            400: OpenApiResponse(description="Bad request - validation errors"),
        },
        tags=["Customers"],
...
class CustomerListView(generics.ListAPIView):
    ...
    @extend_schema(
        ...
        responses={
            200: OpenApiResponse(
                response=CustomerSerializer(many=True), description="List of customers"
            )
        },
        tags=["Customers"],
    )
...
class CustomerDetailView(generics.RetrieveAPIView):
    ...
    @extend_schema(
        ...
        responses={
            200: OpenApiResponse(
                response=CustomerSerializer, description="Customer details"
            ),
...
class CustomerUpdateView(generics.UpdateAPIView):
    ...
    @extend_schema(
        ...
        responses={
            200: OpenApiResponse(
                response=CustomerSerializer, description="Customer updated successfully"
            ),
            400: OpenApiResponse(description="Bad request - validation errors"),
            403: OpenApiResponse(description="Forbidden - can only update own profile"),
            404: OpenApiResponse(description="Customer not found"),
        },
        tags=["Customers"],
    )
...
class CustomerDeleteView(generics.DestroyAPIView):
    ...
    @extend_schema(
        ...
        responses={
            204: OpenApiResponse(description="Customer deactivated successfully"),
            403: OpenApiResponse(description="Forbidden - can only delete own profile"),
            404: OpenApiResponse(description="Customer not found"),
        },
        tags=["Customers"],
    )
...
class PetSitterListView(generics.ListAPIView):
    ...
    def get_queryset(self):
        qs = (
            PetSitter.objects.select_related("user")
            .prefetch_related("animal_types", "service_types")
            .all()
        )
    ...
    @extend_schema(
        ...
        description=(
            "Retrieve a list of petsitters. Optionally filter by search "
            "(name/location), animal_type, or service_type."
        ),
        parameters=[
            OpenApiParameter(
                name="search",
            ...
            OpenApiParameter(
                name="animal_type",
                description=(
                    "Comma-separated animal types (dog, cat, bird, rabbit, "
                    "chicken, hamster, other)"
                ),
                required=False,
                type=str,
            ),
            OpenApiParameter(
                name="service_type",
                description=(
                    "Comma-separated service types (keepsitter, keephost, keepwalk)"
                ),
                required=False,
                type=str,
            ),
...
class PetSitterDetailView(generics.RetrieveAPIView):
    ...
    @extend_schema(
        ...
        responses={
            200: OpenApiResponse(
                response=PetSitterSerializer, description="PetSitter details"
            ),
            404: OpenApiResponse(description="PetSitter not found"),
        },
        tags=["PetSitters"],
    )
    def get(self, request, *args, **kwargs):
...
class PetSitterDeleteView(generics.DestroyAPIView):
    ...
    @extend_schema(
        ...
        responses={
            204: OpenApiResponse(description="PetSitter deactivated successfully"),
            403: OpenApiResponse(description="Forbidden - can only delete own profile"),
            404: OpenApiResponse(description="PetSitter not found"),
        },
        tags=["PetSitters"],
