...
urlpatterns = [
    ...
    path(
        "customers/<int:user_id>/", CustomerDetailView.as_view(), name="customer-detail"
    ),
    path(
    ...
    path(
        "petsitters/<int:user_id>/",
        PetSitterDetailView.as_view(),
        name="petsitter-detail",
    ),
    path(
        "petsitters/<int:user_id>/update/",
        PetSitterUpdateView.as_view(),
        name="petsitter-update",
    ),
    path(
        "petsitters/<int:user_id>/delete/",
        PetSitterDeleteView.as_view(),
        name="petsitter-delete",
    ),
]
